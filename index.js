...
function superbowlWin(record){
    const foundObj=  record.find(winObj=> winObj.result === "W")
...
//console.log(superbowlWin.find(recor => recor.result === "W"));
/*
function superbowlWin (record) {
    if( record.result === "W") {
        return year;
...
//console.log(record.find(superbowlWins));
